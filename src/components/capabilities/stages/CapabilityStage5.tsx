...
import { Brain, Cpu, Database, Zap, X, Info } from 'lucide-react'
...
const CapabilityStage5 = () => {
  ...
  useEffect(() => {
    ...
    startProcessing()
    const interval = setInterval(startProcessing, 5000)
  ...
  const content = {
    ...
    features: [
      { 
        title: "ML Models", 
        description: "Обучение и развертывание",
        icon: Brain,
        color: "purple",
        details: "Обучение моделей машинного обучения, feature engineering, hyperparameter tuning, A/B тестирование"
      },
      { 
        title: "NLP", 
        ...
        icon: Cpu,
        color: "blue",
        details: "Токенизация, векторизация, sentiment analysis, named entity recognition, text classification"
      },
      { 
        title: "Computer Vision", 
        description: "Анализ изображений и видео",
        icon: Database,
        color: "green",
        details: "Object detection, image classification, OCR, face recognition, video analysis, real-time processing"
      },
      { 
        title: "Predictive Analytics", 
        description: "Прогнозирование и аналитика",
        icon: Zap,
        color: "orange",
        details: "Time series forecasting, anomaly detection, recommendation systems, churn prediction, risk assessment"
      }
    ],
    benefits: [
    ...
    guarantee: "Гарантируем эффективные ML решения"
  }
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          >
            ...
            <p className="text-xs text-white/70">Python, TensorFlow...</p>
          </motion.div>
        </div>
