...
import { BarChart3, TrendingUp, PieChart, Activity, X, Info } from 'lucide-react'
...
const CapabilityStage7 = () => {
  ...
  useEffect(() => {
    ...
    startAnalyzing()
    const interval = setInterval(startAnalyzing, 5000)
  ...
  const content = {
    ...
    features: [
      { 
        ...
        description: "BI дашборды и отчеты",
        icon: BarChart3,
        color: "blue",
        details: "Интерактивные дашборды, KPI метрики, автоматические отчеты, drill-down анализ, real-time обновления"
      },
      { 
        title: "Predictive Analytics", 
        description: "Прогнозная аналитика",
        icon: TrendingUp,
        color: "green",
        details: "Machine learning модели, forecasting, trend analysis, anomaly detection, risk assessment, scenario planning"
      },
      { 
        ...
        icon: PieChart,
        color: "purple",
        details: "Интерактивные графики, heat maps, scatter plots, time series, geographic mapping, custom visualizations"
      },
      { 
        ...
        icon: Activity,
        color: "orange",
        details: "Live dashboards, alerting, performance metrics, user behavior tracking, system health monitoring"
      }
    ],
    benefits: [
    ...
    guarantee: "Гарантируем качественную аналитику"
  }
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          >
            ...
            <p className="text-xs text-white/70">Tableau, Power BI, Python...</p>
          </motion.div>
        </div>
