...
import { Smartphone, Monitor, Globe, Zap, X, Info } from 'lucide-react'
...
const CapabilityStage4 = () => {
  ...
  // Микро-анимация масштабирования
  useEffect(() => {
    const startScaling = () => {
    ...
    startScaling()
    const interval = setInterval(startScaling, 6000)
  ...
  const content = {
    ...
    subtitle: "Кроссплатформенные приложения",
    features: [
      { 
        title: "React Native", 
        ...
        icon: Smartphone,
        color: "blue",
        details: "Нативные приложения для iOS и Android, единый код, нативная производительность, доступ к API устройств"
      },
      { 
        title: "Next.js", 
        ...
        icon: Monitor,
        color: "green",
        details: "Server-side rendering, static generation, API routes, оптимизация производительности, SEO"
      },
      { 
        title: "PWA", 
        ...
        icon: Globe,
        color: "purple",
        details: "Service Workers, offline функциональность, push уведомления, установка как нативное приложение"
      },
      { 
        title: "Performance", 
        ...
        icon: Zap,
        color: "orange",
        details: "Code splitting, lazy loading, image optimization, CDN, caching стратегии, Core Web Vitals"
      }
    ],
    benefits: [
    ...
    guarantee: "Гарантируем качественные приложения"
  }
    ...
    <div className="relative w-full h-full flex items-center justify-center p-2">
      ...
      >
        ...
        <div className="text-center mb-4">
          <motion.div
            className="inline-flex items-center justify-center w-10 h-10 mb-2 rounded-full bg-gradient-to-br from-blue-400 to-purple-500"
            animate={isScaling ? {
              scale: [1, 1.1, 1],
              rotate: [0, 5, -5, 0]
            } : {}}
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          >
            ...
            <p className="text-xs text-white/70">React Native, Next.js...</p>
          </motion.div>
        </div>
