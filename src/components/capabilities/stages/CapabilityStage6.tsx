...
import { Shield, Lock, Eye, AlertTriangle, X, Info } from 'lucide-react'
import { useAppStore } from '@/store/appStore'

const CapabilityStage6 = () => {
  ...
  const securingTimeoutRef = useRef<NodeJS.Timeout | null>(null)
  const pulseTimeoutRef = useRef<NodeJS.Timeout | null>(null)

  // Микро-анимация безопасности
  useEffect(() => {
    const startSecuring = () => {
      ...
      if (securingTimeoutRef.current) {
        clearTimeout(securingTimeoutRef.current)
      }
      
      securingTimeoutRef.current = setTimeout(() => {
        setIsSecuring(false)
      }, 2000)
    }

    startSecuring()
    const interval = setInterval(startSecuring, 5000)
  ...
  const content = {
    ...
    features: [
      { 
        ...
        icon: Shield,
        color: "blue",
        details: "Автоматизированное и ручное тестирование, vulnerability assessment, security audit, compliance проверки"
      },
      { 
        ...
        icon: Lock,
        color: "green",
        details: "AES-256, RSA, end-to-end encryption, key management, secure key storage, certificate management"
      },
      { 
        title: "Monitoring", 
        ...
        icon: Eye,
        color: "purple",
        details: "SIEM, real-time monitoring, threat detection, incident response, security analytics, log analysis"
      },
      { 
        title: "Compliance", 
        ...
        icon: AlertTriangle,
        color: "orange",
        details: "GDPR, SOX, HIPAA, PCI DSS, ISO 27001, SOC 2, audit preparation, compliance reporting"
      }
    ],
    benefits: [
      "Защита от кибератак",
    ...
    timeline: "4-8 недель",
    guarantee: "Гарантируем безопасность ваших данных"
  }
    ...
    <div className="relative w-full h-full flex items-center justify-center p-2">
      ...
      >
        ...
        <div className="text-center mb-4">
          <motion.div
            className="inline-flex items-center justify-center w-10 h-10 mb-2 rounded-full bg-gradient-to-br from-blue-400 to-green-500"
            animate={isSecuring ? {
              scale: [1, 1.1, 1],
              rotate: [0, 5, -5, 0]
            } : {}}
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          >
            ...
            <p className="text-xs text-white/70">OWASP, NIST, Burp Suite...</p>
          </motion.div>
        </div>
...
export default CapabilityStage6