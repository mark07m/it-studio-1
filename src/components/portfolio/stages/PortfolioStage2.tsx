...
const PortfolioStage2 = () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-8">
      ...
      >
        {/* Portfolio Card для P2 - E-commerce Platform */}
        <div className={`glass-card glass-hover rounded-2xl p-8 backdrop-blur-md ${
          ...
          <p className="text-white/70 mb-8 leading-relaxed">
            Полнофункциональная платформа электронной коммерции. 10K+ товаров, 50K+ заказов, 
            $2M+ оборот. Интеграция с 15+ платежными системами и логистическими партнерами.
          </p>
